...
def get_page_minsk(area1, area2, n):
    return "https://pk.api.onliner.by/search/apartments?area%5Bmin%5D={}&area%5Bmax%5D={}&bounds%5Blb%5D%5Blat%5D=53.809166100718116&bounds%5Blb%5D%5Blong%5D=27.342224121093754&bounds%5Brt%5D%5Blat%5D=53.986780183052055&bounds%5Brt%5D%5Blong%5D=27.78167724609375&v=0.12052430637493972&page={}".format(
        area1, area2, n)
